...
using System.Linq; // <--- IMPORTANT: Required for ToDictionary and MaxBy
...
namespace BahyWay.RulesEngine.Models
{
    ...
    public class LinguisticVariable
    {
        ...
        // Internal dictionary to store sets by name
        ...
        {
            // This relies on FuzzySet having a GetMembership method
